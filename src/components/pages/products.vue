        ...
        <table class="table mt-4">
            ...
            <tbody>
                <tr v-for="(item, key) in products" :key="item.id">
                    ...
                    <td>
                        <button class="btn btn-outline-secondary btn-sm" @click="openModel(false, item)">編輯</button>
                    </td>
                    <td>
        ...
        <div class="modal fade" id="delProductModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content border-0">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-outline-secondary" data-dismiss="modal">取消</button>
                            <button type="button" class="btn btn-danger" @click="DeleteProdect">確認刪除</button>
                        </div>
                    </div>
                </div>
            </div>
